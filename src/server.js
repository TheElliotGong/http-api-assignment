...
const badRequestInvalidMessage = {
...
const unauthorizedInvalidMessage = {
  message: 'Missed loggedIn query parameter set to yes.',
  id: 'unauthorized',
};
  ...
  switch (parsedUrl.pathname) {
    ...
    case '/badRequest':
      responseHandler.queryResponse(
        ...
        response,
        acceptedType,
        badRequestValidMessage,
        badRequestInvalidMessage,
        params,
        'valid',
        'true',
        badRequestStatuses,
    ...
    case '/unauthorized':
      responseHandler.queryResponse(
        ...
        response,
        acceptedType,
        unauthorizedValidMessage,
        unauthorizedInvalidMessage,
        params,
        'loggedIn',
        'yes',
